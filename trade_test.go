...
func Test_Futures_Trade(t *testing.T) {
	...
	mnqOrder := IBOrder{Conid: mnq.Conid, SecType: strconv.Itoa(mnq.Conid) + ":FUT", COID: "TEST001", OrderType: "MKT", ListingExchange: "SMART", Side: "BUY", Tif: "DAY", Referrer: "GOIBCP", Quantity: 1}
